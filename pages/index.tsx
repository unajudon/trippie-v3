...
export default function Home() {
  ...
  return (
<main className="relative min-h-screen w-full bg-gradient-to-br from-[#3E1F92] via-[#5C35DB] to-[#10DBAC] flex items-start justify-center pt-10 md:pt-16 px-4 font-poppins text-white overflow-hidden">
      ...
      {/* Main image card with adjusted vertical position */}
      <motion.div
  initial={{ opacity: 0, scale: 0.95 }}
  animate={{ opacity: 1, scale: 1 }}
  transition={{ duration: 0.6, ease: 'easeOut' }}
  className="relative z-10 w-full max-w-md h-[70vh] rounded-3xl overflow-hidden shadow-2xl border border-white/10"
>
        ...
        {/* Card text content */}
<div className="relative z-10 flex flex-col justify-between h-full p-4 text-center text-white">
          <div className="mt-4">
