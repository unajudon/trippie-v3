...
export default function Home() {
  ...
  return (
<main className="relative min-h-screen w-full bg-gradient-to-br from-[#3E1F92] via-[#5C35DB] to-[#10DBAC] flex items-center justify-center px-4 font-poppins text-white overflow-hidden">
